...
public class NewsCenterPager extends BasePager {
    ...
    private ArrayList<BaseDatailPage> DetailPages=new ArrayList<>();
    ...
    public void initData(){
        ...
        DetailPages.add(new InteractMenuDetailPager((MainActivity)mActivity));
        DetailPages.add(new NewsMenuDetailPager((MainActivity)mActivity,newsMenu.data.get(0).children));
        DetailPages.add(new PhotoMenuDetailPager((MainActivity)mActivity));
        DetailPages.add(new TopicMenuDetailPager((MainActivity) mActivity));
...
//            });
    ...
    public void setCurrentDetailPager(int i){
        View view=DetailPages.get(i).initView();
